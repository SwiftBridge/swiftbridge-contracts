...
const START_FROM_INDEX = 5; // Continue from TaskManager (index 5)

async function main() {
  console.log("🚀 Continuing Multi-Contract Interaction Script...\n");
  console.log(`Starting from contract ${START_FROM_INDEX + 1}\n`);
  ...
  console.log(`📍 Continuing from contract ${START_FROM_INDEX + 1}/${deployedContracts.length}\n`);

  let totalTxCount = NUM_WALLETS;

  // Interact with remaining contracts
  ...
  console.log(`📝 Contracts Processed: ${deployedContracts.length - START_FROM_INDEX}`);
